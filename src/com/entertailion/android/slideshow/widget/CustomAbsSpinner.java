...
public abstract class CustomAbsSpinner extends CustomAdapterView<SpinnerAdapter> {
	...
	public CustomAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
		...
		TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.CustomAbsSpinner, defStyle, 0);

		CharSequence[] entries = a.getTextArray(R.styleable.CustomAbsSpinner_entries);
		if (entries != null) {
			ArrayAdapter<CharSequence> adapter = new ArrayAdapter<CharSequence>(context, R.layout.simple_spinner_item, entries);
	...
	static class SavedState extends BaseSavedState {
		 ...
		 * {@link CustomAbsSpinner#onSaveInstanceState()}
		 */
