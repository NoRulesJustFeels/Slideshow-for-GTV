 ...
 */
package com.entertailion.android.slideshow.widget;
...
public class EcoGallery extends CustomAbsSpinner implements GestureDetector.OnGestureListener {
	...
	private static final String TAG = "EcoGallery";
	 ...
	 */
	private static final int SCROLL_TO_FLING_UNCERTAINTY_TIMEOUT = 500; // 250;
...
//		dispatchLongPress(mDownTouchView, mDownTouchPosition, id);
	...
	private class FlingRunnable implements Runnable {
		...
		public void run() {
			...
			// Flip sign to convert flinger direction to list items direction
			// (e.g. flinger moving down means list is moving towards the top)
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		mGalleryCenter = (getWidth() - getPaddingLeft() - getPaddingRight()) / 2 + getPaddingLeft();
